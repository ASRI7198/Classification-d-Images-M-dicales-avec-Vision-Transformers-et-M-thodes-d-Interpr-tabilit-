...
for i, test_data in enumerate(test_loader):
    ...
    plt.savefig(os.path.join("/home/rasri/PycharmProjects/Stage_ASRI_RIDA_INTERPRETABILITY/Heatmap/Captum/GradientShap", Name),
                bbox_inches='tight',
                pad_inches=0)
    ...
    colors_df.to_csv(os.path.join(f"/home/rasri/PycharmProjects/Stage_ASRI_RIDA_INTERPRETABILITY/Fichier CSV color "
                                  f"/Captum/GradientShap/{Name}"), index=False)
    plt.close()
