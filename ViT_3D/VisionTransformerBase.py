# vision transformer 3D for init FlexiVit 3D
...
from ViT_3D.PatchEmbeddingBlockBase import PatchEmbeddingBlock
from ViT_3D.transformerblock import TransformerBlock
...
class ViT(nn.Module):
    ...
    def __init__(
            ...
            qkv_bias: bool = False,
            embed_layer: nn.Module = PatchEmbeddingBlock,
        ...
        self.patch_embedding = embed_layer(  # to FlexitPatchEmbedding
    ...
    def forward(self, x):
        ...
        for blk in self.blocks:
            ...
            attention_weights_out.append(attn_weights)
        ...
        return x, attention_weights_out
